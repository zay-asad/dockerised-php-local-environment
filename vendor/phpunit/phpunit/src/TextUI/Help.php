...
final class Help
{
    ...
    private const HELP_TEXT = [
        ...
        'Test Selection Options' => [
            ...
            ['arg' => '--covers <name>', 'desc' => 'Only runs test annotated with "@covers <name>"'],
            ['arg' => '--uses <name>', 'desc' => 'Only runs test annotated with "@uses <name>"'],
        ...
        'Test Execution Options' => [
            ...
            ['arg'    => '--fail-on-incomplete', 'desc' => 'Treat incomplete test as failures'],
            ['arg'    => '--fail-on-risky', 'desc' => 'Treat risky test as failures'],
            ['arg'    => '--fail-on-skipped', 'desc' => 'Treat skipped test as failures'],
